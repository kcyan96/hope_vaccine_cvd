...
#cohort_postacute <- readRDS("cohort_postacute_jiayi.RDS")
...
saveRDS(cohort_180, "cohort_acute_180_jiayi.RDS")


## Weighting ---------------------------------------------
cohort_full <- readRDS("cohort_acute_180_jiayi.RDS")
# SELECT comparison
...
sink(paste0("output/T2_acute_28d_exl180_log_jiayi.txt"), append=F, split=T)
print("Table 2")
for(oc in OUTCOMES) {
  cat(oc, "\n")
