...
res_65 <- sapply(c("postacute"), function(p) run_fit(cohort[Age<65], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_66 <- sapply(c("postacute"), function(p) run_fit(cohort[Age>=65], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_m <- sapply(c("postacute"), function(p) run_fit(cohort[sex=="M"], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_f <- sapply(c("postacute"), function(p) run_fit(cohort[sex=="F"], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_cci3 <- sapply(c("postacute"), function(p) run_fit(cohort[score.cci.age<4], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_cci4 <- sapply(c("postacute"), function(p) run_fit(cohort[score.cci.age>=4], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_sev1 <- sapply(c("postacute"), function(p) run_fit(cohort[severity==1], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_sev0 <- sapply(c("postacute"), function(p) run_fit(cohort[severity==0], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_bnt <- sapply(c("postacute"), function(p) run_fit(cohort[group=="X"|BNT162b2==1], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_sino <- sapply(c("postacute"), function(p) run_fit(cohort[group=="X"|CoronaVac==1], p, OUTCOMES), simplify=F, USE.NAMES=T)
...
res_65_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[Age<65], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_66_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[Age>=65], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_m_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[sex=="M"], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_f_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[sex=="F"], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_cci3_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[score.cci.age<4], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_cci4_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[score.cci.age>=4], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_sev1_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[severity==1], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_sev0_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[severity==0], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_bnt_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[group=="X"|BNT162b2==1], p, OUTCOMES), simplify=F, USE.NAMES=T)
res_sino_IR <- sapply(c("postacute"), function(p) run_fit_IR(cohort[group=="X"|CoronaVac==1], p, OUTCOMES), simplify=F, USE.NAMES=T)
